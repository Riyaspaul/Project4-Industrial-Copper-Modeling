    ...
    if select == 'Selling Price':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('D:/PythonProjects/INDUSTRIALCOPPERMODELLING/Regressormodelfile.pkl','rb') as files:
    ...
    if select == 'Status':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('D:/PythonProjects/INDUSTRIALCOPPERMODELLING/Classifiermodelfile.pkl','rb') as files:
